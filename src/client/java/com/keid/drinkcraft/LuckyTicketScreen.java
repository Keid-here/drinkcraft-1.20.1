...
public class LuckyTicketScreen extends BaseUIModelScreen<FlowLayout> {


    public LuckyTicketScreen() {
        super(FlowLayout.class, DataSource.asset(new Identifier("drinkcraft", "lucky_scratch_model")));
    }
    ...
    protected void build(FlowLayout rootComponent)
    {
        ...
        rootComponent.childById(ButtonComponent.class, "confirm").onPress(button -> {
            ...
            if (isBetween(finalScore, 0, 20)){
                ...
                Drinkcraft.DRINKCRAFTOWOCHANNEL.clientHandle().send(new PricePacket("neutral", 2, new Identifier(MOD_ID, "drinkcraftowothree")));
            }
            else if (isBetween(finalScore, 56, 75)){
                Drinkcraft.DRINKCRAFTOWOCHANNEL.clientHandle().send(new PricePacket("reward", 1, new Identifier(MOD_ID, "drinkcraftowofour")));
            }
            else if (isBetween(finalScore, 76, 80)){
                Drinkcraft.DRINKCRAFTOWOCHANNEL.clientHandle().send(new PricePacket("reward", 2, new Identifier(MOD_ID, "drinkcraftowofive")));
            }
            else if (isBetween(finalScore, 81, 90)){
                Drinkcraft.DRINKCRAFTOWOCHANNEL.clientHandle().send(new PricePacket("reward", 3, new Identifier(MOD_ID, "drinkcraftowosix")));
            }
            else if (isBetween(finalScore, 91, 100)){
                Drinkcraft.DRINKCRAFTOWOCHANNEL.clientHandle().send(new PricePacket("reward", 2, new Identifier(MOD_ID, "drinkcraftowofive")));
