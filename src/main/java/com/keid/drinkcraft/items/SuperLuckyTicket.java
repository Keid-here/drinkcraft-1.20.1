...
public class SuperLuckyTicket extends Item {

    public SuperLuckyTicket() {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        Drinkcraft.DRINKCRAFTOWOCHANNEL.serverHandle(user).send(new ScratchS2C("superlucky", new Identifier(MOD_ID, "drinkcraftowonet")));
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.literal("way more rewards").formatted(Formatting.LIGHT_PURPLE));
    }
}
